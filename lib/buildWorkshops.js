  ...
  try {
    ...
    if (spreadsheetId && apiKey) {
      try {
        ...
        console.warn('⚠️ Failed to fetch from Google Sheets, using static workshops:', error.message);
      }
    } else {
      console.warn('⚠️ Google Sheets credentials not found, using static workshops only');
    }
